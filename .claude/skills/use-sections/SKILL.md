...
Сегодня закон нарушен в трёх местах фабрики (`standard-content-page.tsx`): оглавление, вопрос-ответ и
ссылка «назад». Пока шаг 542 не закрыт, каталог секций показывает НЕ ВСЁ, из чего собрана страница, —
об этом говорить прямо, а не умалчивать.
