...
**Сегодня закон нарушен в трёх местах** (шаг 542): оглавление рисует свой `<nav>`, вопрос-ответ — свой
`<dl>` с переизобретёнными карточками, ссылка «назад» — инлайновый `<svg>` вместо `lucide-react`.
Пока шаг не закрыт, каталог секций показывает не всё, из чего собрана страница, — и говорить обратное
владельцу нельзя.
