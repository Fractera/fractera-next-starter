...
Три части обязательны все. Первая ловит непонятую просьбу до того, как она стала кодом; вторая
показывает цену раньше, чем она заплачена; третья называет приёмку словами владельца, а не гейтами.

🔒 **Не сошлось — спрашиваешь, а не достраиваешь.** Пересказ, в котором ты дописал за владельца
подробность, которой он не называл, — это выдуманная задача, и дальше ты строишь её, а не его.
Не уверен — так и говори: «не уверен в этом месте» стоит одной строки, выдуманное задание стоит дня.
