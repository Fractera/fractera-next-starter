...
Правка платформы заказывается письмом: панель → «Как построить этот проект» → врезка «Изменения в
самой платформе». Твоя часть — назвать службу, файл, строку и сказать, есть ли обход.
