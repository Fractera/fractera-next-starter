...
| `use-object-storage` | медиатека: загрузка, превью, подрезка, иконки | — |
...
| `use-channels` | каналы связи (Telegram) — поверхность в четыре маршрута, описана разделом в `use-data` §3 | — |
