...
новых инструментов и оформления ты активно ищешь и ставишь в проект чужие навыки — этим занят навык
`find-skill`.**
...
| `find-skill` | найти и поставить чужой навык: где искать, что можно ставить, куда ему разрешено писать | — |
