...
> `ai-draft-settings.md` §«Naming convention». Навык `scaffold-route` пока grandfathered;
> `create-draft` приведён к правилу — переименован в `propose-new-agent-skill-or-mcp`.
