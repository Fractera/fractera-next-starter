...
> Стандарты MCP (имя `<tier>_<area>_<action>_<object>`, обязательный confirm-before-mutation у
> мутирующих, тиры public/user/owner) — в `ai-draft-settings.md` §«MCP access» и в MCP-REGISTRY.
> При создании нового MCP/навыка действует **правило 19 dev-session**: синхронно дописать публичную
> FES-документацию с пометкой тира.
