# 24 — Fetch new messages from Telegram (getUpdates)

> Project sub-step · node `fetch-telegram-updates` · kind: action · importance: mandatory · order sheet `os-bed7109d7be27ad4` (2/9)
