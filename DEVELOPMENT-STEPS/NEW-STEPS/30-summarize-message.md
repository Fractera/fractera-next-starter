# 30 — Detailed message summary (cheap model)

> Project sub-step · node `summarize-message` · kind: action · importance: mandatory · order sheet `os-bed7109d7be27ad4` (5/9)
