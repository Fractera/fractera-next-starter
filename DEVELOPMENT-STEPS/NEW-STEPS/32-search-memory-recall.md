# 32 — Find an answer in the notes (LightRAG query)

> Project sub-step · node `search-memory-recall` · kind: action · importance: mandatory · order sheet `os-bed7109d7be27ad4` (6/9)
