...
const meta: RouteMeta = {
  ...
  filePath: "app/app/(projects)/projects/automation/page.tsx",
  status: "live",
  todo: [],
  ...
  description:
    "Automation category hub of the Projects layer — repeatable business automations, each a finished-cycle tool: an n8n for one single task.",
  dataDependencies: ["filesystem: project folders under app/(projects)/projects/automation/"],
  ...
  notes:
    ...
    "a project = a NAMED folder /projects/automation/<project-slug> — dynamic segments " +
