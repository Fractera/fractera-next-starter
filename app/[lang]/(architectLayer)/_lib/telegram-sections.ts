...
export const TELEGRAM_SECTIONS = [
  ...
  "logs",
  "settings",
  // 🔒 «СТРАТЕГИЯ АВТОМАТИЗАЦИИ» — ОТДЕЛЬНЫЙ РАЗДЕЛ, А НЕ КАРТОЧКА В НАСТРОЙКАХ
  // (выбор владельца 2026-09-04, шаг 112). Настройки описывают КОНКРЕТНОГО бота —
  // токен, привязку, расписание; этот раздел отвечает на вопрос, ЧЕМ вообще
  // автоматизируется проект, и содержимого в нём на целый экран. Шестой карточкой
  // поверх пяти он читался бы как настройка бота, которой не является.
  "automation",
