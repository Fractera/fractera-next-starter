...
// слоя: соседи переехали на общую раскладку ещё шагом 49, а она осталась в чужой
// оболочке — и рисовала слева восемь групп настроек проекта. Владелец увидел
// ровно это: «избыточные и не связанные инструменты».
// 🪦 Самого меню (`_components/layer-menu.tsx`) больше нет: лишившись здесь
// последнего потребителя, оно удалено 2026-08-31 по слову владельца.
//
