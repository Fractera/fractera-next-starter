// Слова таблицы покупателя — СВОИ (шаг 521, разбор 2026-08-21).
//
// 🔒 ИМЕННО ЗДЕСЬ ОБЩИЙ СЛОВАРЬ БЫЛ ДОРОЖЕ ВСЕГО. Покупатель — единственный, кто
// смотрит на этот список не по работе, а ради покупки: ему уместны «Товар» и
// «Стоимость», а не «Позиция» и «Цена закупки». Пока слова были общими, витринная
// речь не могла отличаться от складской ни в одном языке.
//
...
const UI: Record<string, ShopTableUi> = {
...
export function shopTableUi(lang: string): ShopTableUi {
