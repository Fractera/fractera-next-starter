...
// Поведение списка покупателя — СВОЁ, а не общее (шаг 521).
//
// 🔒 ЗАЧЕМ КОПИЯ. Витрина внутри аккаунта живёт по другим правилам, чем рабочее
// место: покупателю нужны наличие, скидки, порядок «сначала дешёвые». Пока
// движок был общим, ни одно из этих правил нельзя было ввести, не изменив
// таблицы персонала, бухгалтерии и администрирования разом.
//
...
const SIZE_KEY = "fractera-shopping-per-page"
export const PAGE_SIZES = [10, 20, 50, 100]

type LoadOpts = { page?: number; perPage?: number; q?: string }

export function useShopList(failedLabel: string) {
