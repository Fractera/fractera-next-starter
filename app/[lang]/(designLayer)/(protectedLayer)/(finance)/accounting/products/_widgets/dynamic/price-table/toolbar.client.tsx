...
// Управление списком цен: заголовок, раскрытие, поиск.
//
// 🔒 ЗДЕСЬ НЕТ КНОПКИ «ДОБАВИТЬ» — И НЕТ ДАЖЕ ПОЛЕЙ ПОД НЕЁ. Общий тулбар их
// объявлял, и бухгалтерия, чтобы кнопку спрятать, передавала `add: ""` и
...
//
// Заводить товары бухгалтеру нечем. Поэтому кнопки нет физически, и передать
// сюда «пустое имя кнопки» больше не у чего.
//
