...
export const en: FooterPageCell = {
  ...
  description: 'The rules for using this site and its services.',
  ...
  blocks: [
    ...
    { kind: 'p', text: 'Terms of service set out what you promise your visitors and what you expect from them.' },
  ],
}
