...
// Подвал списка покупателя: сколько товаров, сколько на странице, переходы.
//
// 🔒 СВОЙ, А НЕ ОБЩИЙ (шаг 521). Покупатель листает не по работе: ему уместен
// короткий шаг и, возможно, когда-нибудь кнопка «показать ещё» вместо страниц.
// Пока подвал был общим, такое изменение задевало три чужие таблицы разом и
// потому не делалось.
//
