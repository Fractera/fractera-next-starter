...
// Управление каталогом администратора: заголовок, раскрытие, поиск.
//
// 🔒 ЗДЕСЬ НЕТ КНОПКИ «ДОБАВИТЬ» — И НЕТ ДАЖЕ ПОЛЕЙ ПОД НЕЁ. Общий тулбар их
// объявлял, и администрирование, чтобы кнопку спрятать, передавало `add: ""` и
// `cancelAdd: ""`. Пустая строка как способ выключить возможность — признак
// того, что компонент принадлежит не тому, кто им пользуется: право описывалось
// не отсутствием кода, а фальшивым значением, и о нём надо было помнить.
//
// Заводить товары администратор не может — он их удаляет. Поэтому кнопки нет
// физически, и передать сюда «пустое имя кнопки» больше не у чего.
//
