...
// Подвал каталога администратора: сколько записей, сколько на странице, переходы.
//
// 🔒 СВОЙ, А НЕ ОБЩИЙ (шаг 521). Администратор просматривает весь каталог целиком
// и листает его сотнями, а покупатель — десятками; пока размеры страницы жили в
// общем движке, разные привычки были невыразимы. Здесь они свои.
//
