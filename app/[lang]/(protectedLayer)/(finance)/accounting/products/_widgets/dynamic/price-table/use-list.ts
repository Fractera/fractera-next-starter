...
// Поведение списка цен — СВОЁ, а не общее (шаг 521, разбор 2026-08-21).
//
...
// разбивку на страницы, одинаковый поиск, одинаковое «раскрыть по кнопке» и
// один ключ размера страницы на всех. Пока он один, бухгалтерия не может завести
// бесконечную ленту вместо страниц, а покупатель — иную выборку: изменение ради
// одного слоя ломает три остальных, и потому не делается вовсе.
//
...
// поставивший 100 строк в бухгалтерии, получал 100 строк в магазине. Это разные
// задачи и разные привычки: цену листают иначе, чем каталог.
const SIZE_KEY = "fractera-accounting-per-page"
export const PAGE_SIZES = [10, 20, 50, 100]

type LoadOpts = { page?: number; perPage?: number; q?: string }

export function usePriceList(failedLabel: string) {
