...
// Редактируемое поле карточки — один компонент на все поля ЭТОЙ карточки.
//
// 🔒 ПЕРЕЕХАЛО ИЗ `_components/products/` (шаг 521). Там оно лежало среди частей
// таблицы, которой не пользуется, и звалось общим — при единственном
// потребителе. Общее в проекте — это ответ на вопрос «как проект вообще делает
// X»; поле правки на месте отвечает на вопрос «как ведёт себя ЭТА карточка», и
// потому живёт внутри неё.
//
