...
// Подвал списка персонала: сколько записей, сколько на странице, переходы.
//
...
// четырёх. Здесь размеры свои, и рабочее место вправе листать иначе, чем касса.
//
