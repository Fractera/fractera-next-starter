...
const meta: RouteMeta = {
  ...
  filePath: "app/app/api/glossary/[id]/route.ts",
  status: "live",
  todo: [],
  ...
  isDynamicRoute: true,
  segmentParams: ["id"],
  pathParams: [{ name: "id", description: "Glossary entry id to remove.", required: true }],
  ...
  description: "Remove a single glossary entry (step 107).",
