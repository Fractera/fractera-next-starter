...
// A file-explorer tree on the left, the accompanying file on the right (roles,
// static/dynamic, method). "Add page" opens a right-side panel to declare a new
// page as a to-do list — a flag an agent picks up to plan and build it (§3.11).
