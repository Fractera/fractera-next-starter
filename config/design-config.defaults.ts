...
export type DesignConfig = {
  ...
  /**
   * Разрешён ли кастомный дизайн — страницы вне оформления платформы (шаг 538).
   *
   * 🔒 УМОЛЧАНИЕ — ЗАПРЕЩЕНО, и это конструкция, а не осторожность. Страница в
   * свободном слое теряет палитру владельца, меню, подвал, баннер согласия,
   * JSON-LD и обвязку приложения; отлаживает её дальше архитектор руками.
   * Дверь, закрытая по умолчанию, не открывается по недосмотру агента.
   *
   * Читается из файла на диске при генерации — статика сохраняется, значение
   * приезжает на ближайшей ревалидации.
   */
