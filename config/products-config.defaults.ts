...
export type PlannedPage = {
  /** Адрес страницы; файл выводится из него и корня продукта. */
  path: string;
  /** Что здесь работает и зачем страница нужна — саммари для человека. */
  purpose: string;
  /**
   * Слаги кейсов, которым служит страница. Массив: одна страница закрывает
   * несколько сценариев чаще, чем один. Пусто — законное состояние служебной
   * страницы, и врать про связь ради красоты списка нельзя.
   */
  cases?: string[];
};
