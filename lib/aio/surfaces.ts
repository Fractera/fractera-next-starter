...
import { blogPost } from '@/app/[lang]/(designLayer)/(publicLayer)/blog/_lib/post'
import { POSTS } from '@/app/[lang]/(designLayer)/(publicLayer)/blog/_list.generated'
import { getBlogUi } from '@/app/[lang]/(designLayer)/(publicLayer)/blog/_data'
import { catalogueUi } from '@/app/[lang]/(designLayer)/(publicLayer)/products/_data'
import { footerPage } from '@/lib/pages/footer-page'
import { data as privacyData } from '@/app/[lang]/(designLayer)/(publicLayer)/(footerPages)/privacy/_data'
import { data as termsData } from '@/app/[lang]/(designLayer)/(publicLayer)/(footerPages)/terms/_data'
import { data as cookiesData } from '@/app/[lang]/(designLayer)/(publicLayer)/(footerPages)/cookies/_data'
import { data as architectureData } from '@/app/[lang]/(designLayer)/(publicLayer)/(footerPages)/architecture/_data'
import { data as accessibilityData } from '@/app/[lang]/(designLayer)/(publicLayer)/(footerPages)/accessibility/_data'
