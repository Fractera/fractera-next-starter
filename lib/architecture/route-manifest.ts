...
import dashboardMeta from "@/app/(service)/dashboard/_meta"
import aiCoreMeta from "@/app/(service)/ai-core/_meta"
import architectureMeta from "@/app/(service)/architecture/_meta"
import debugMeta from "@/app/(service)/debug/_meta"
...
import telegramReminderMeta from "@/app/(service)/project/my-telegram-reminder/_meta"
import glossaryPageMeta from "@/app/(service)/glossary/_meta"
