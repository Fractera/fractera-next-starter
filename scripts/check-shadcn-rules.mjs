...
const KNOWN_DEBT = [
  {
    file: "components/form/voice-control.client.tsx",
    rules: ["no-literal-colour", "no-manual-dark"],
    since: "2026-08-31",
    why: "статусные цвета голосового поля: красный «идёт запись» и янтарный «не получилось». Токена ни для одного из двух состояний в палитре нет; замена на destructive перекрасила бы предупреждение в цвет отказа. Ждёт решения владельца — завести роли статуса в DESIGN-CONFIG или узаконить эти два цвета",
  },
]
