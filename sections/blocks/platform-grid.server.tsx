...
//
// 🔒 ПОДСВЕТКА ПОД КУРСОРОМ СМОТРИТ В ЦЕНТР СЕТКИ ПО ГОРИЗОНТАЛИ — по колонке, а
// не по номеру ячейки. В источнике направления лежат массивом из шести и
// раздаются по индексу: седьмая ячейка не получит ничего, а вставка новой
// посередине молча развернёт все последующие. Вертикальную составляющую я не
// переношу сознательно: она зависит от числа СТРОК, которого разметка не знает,
// и в источнике зашита под ровно шесть ячеек.
